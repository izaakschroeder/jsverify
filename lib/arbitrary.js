...
var contains = require("./generator.js");
...
function either(a, b) {
  ...
  return arbitraryBless({
    contains: contains.either(a.contains, b.contains),
...
function tuple(arbs) {
  ...
  return arbitraryBless({
    contains: contains.tuple(utils.pluck(arbs, "contains")),
...
function sum(arbs) {
  arbs = arbs.map(utils.force);
  return arbitraryBless({
    contains: contains.sum(utils.pluck(arbs, "contains")),
...
function oneof() {
  ...
  var append = function (a) {
    var e = utils.force(a);
    generators.push(e.generator);
    containsers.push(e.contains);
  };
  ...
  return arbitraryBless({
    contains: contains.oneof(containsers),
